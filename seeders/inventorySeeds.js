const inventorySeeds = [
  ...
  },
  {
    ...
    description: "A small painting of a cute dog in what seems to be a hand-made frame!",
    category: "Art",
    price: "12",
    condition: "Very Good",
  ...
  },
  {
    ...
    description: "Orange and black chairs straight out of an old movie theater!",
    category: "Furniture",
    price: "85",
    condition: "Very Good",
  ...
  },
  {
    ...
    description: "DVD Box set with the extended editions of The Lord of the Rings trilogy",
    category: "Entertainment",
    price: "35",
    condition: "Very Good",
  ...
  },
  {
    ...
    description: "Terrifying collection of cabbage patch kids, no guarantee they're not haunted. Please buy.",
    category: "Games/Toys",
    price: "2",
    condition: "Good",
  ...
  },
  {
    _id: new mongoose.Types.ObjectId(),
    name: "Super 8 Camera",
    category: "Vintage Argus Showmaster Super 8 camera!",
    price: "53",
    condition: "Not Functioning/Just for Parts",
  ...
  },
  {
    ...
    description: "An old orange-spackled couch that has two side tables attached.",
    category: "Furniture",
    price: "185",
    condition: "Very Good",
  ...
  },
  {
    ...
    description: "Retro style lounge with a blue-green cover, metal and wood frame.",
    category: "Furniture",
    price: "175",
    condition: "Good",
